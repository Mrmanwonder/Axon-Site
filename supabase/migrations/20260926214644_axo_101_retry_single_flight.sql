...
comment on function public.submit_paper(
  ...
  'AXO-101. Idempotent paper submit/resubmit. Paper-scoped advisory locking guarantees one live extraction run; failed/rejected latest runs may be replaced, stored page keys survive, and page-stage state resets only when a fresh run is created.';
