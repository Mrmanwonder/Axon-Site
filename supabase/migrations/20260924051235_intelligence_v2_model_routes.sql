...
-- This is the reviewed route migration required by Intelligence Layer v2.
-- Sampling values stay for historical rollback, but Gemini 3.5 behavior is
-- controlled through thinking_level, evidence, tools, and verification.
